...
Route::group(['namespace'=>'Amcoders\Plugin\Paymentgetway\http\controllers','middleware'=>['web','auth']],function(){
    ...
    Route::get('klarna-fallback','KlarnapayController@klarna_success_payment')->name('klarna_fallback');

    Route::get('swish-fallback','SwishpayController@swish_success_payment')->name('swish_fallback');
