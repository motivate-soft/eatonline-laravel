        ...
        <form method="post" id="basicform" action="{{ route('store.order.update',$info->id) }}">
          ...
          <div class="row">
              <div class="form-group col-lg-12">
                  <label>{{__('Fulfillment Time')}} ( mins)</label>
                  <input class="form-control" name="fulfillmentTime" value="{{$info->fulfillment_time}}" min="0" step="1" @if($info->status != 2) readonly @endif>
              </div>
