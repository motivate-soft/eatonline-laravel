...
Route::group(['namespace'=>'Amcoders\Theme\khana\http\controllers','middleware'=>'web'],function(){
	...
	Route::post('add-delivery-fee', 'CartController@add_delivery_fee');
...
Route::group(['namespace'=>'Amcoders\Theme\khana\http\controllers','middleware'=>['web','auth', 'verified']],function(){
...
Route::get('payment-success', 'Amcoders\Theme\khana\http\controllers\OrderController@payment_success')->name('payment.success');

Route::get('payment-fail', 'Amcoders\Theme\khana\http\controllers\OrderController@payment_fail')->name('payment.fail');
Route::get('orderCheck/{id}', 'Amcoders\Theme\khana\http\controllers\OrderController@order_check')->name('order.check');

Route::group(['namespace'=>'Amcoders\Theme\khana\http\controllers\Admin','middleware'=>['web','auth','admin', 'verified'],'prefix'=>'admin/', 'as'=>'admin.'],function(){
...
Route::group(['as' =>'rider.','prefix'=>'rider','namespace'=>'Amcoders\Theme\khana\http\controllers\Rider','middleware'=>['web','auth','rider','riderapproval', 'verified']],function(){
	// dashboard route
...
Route::group(['as' =>'author.','prefix'=>'author','namespace'=>'Amcoders\Theme\khana\http\controllers\Author','middleware'=>['web','auth', 'verified']],function(){
	// dashboard route
	Route::get('dashboard','DashboardController@dashboard')->name('dashboard');
