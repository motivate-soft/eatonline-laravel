...
Route::group(['namespace'=>'Api\Customer','middleware'=>'auth:sanctum'],function(){
	...
	Route::get('/customer/order_check/{id}', 'OrderController@order_check');
});
...
Route::group(['namespace' => 'Api\Restaurant', 'prefix'=>'restaurant', 'middleware' => ['auth:sanctum', 'restaurant']], function() {

    //For delivery
    Route::get('delivery/index', 'DeliveryLocationController@index');
    Route::get('delivery/create', 'DeliveryLocationController@create');
    Route::post('delivery/store', 'DeliveryLocationController@store');
    Route::get('delivery/show/{id}', 'DeliveryLocationController@show');
    Route::post('delivery/update', 'DeliveryLocationController@update');
    Route::post('delivery/destroy', 'DeliveryLocationController@destroy');
